...
int main(int argc, char* argv[]){
    ...
    std::string symbols = "bac,tsla,fish,FLWS,FCTY,FCCY,SRCE,FUBC,VNET,JOBS,EGHT,AVHI,SHLM,AAON,ASTM,ABAX,ABMD,AXAS,ACTG,rai,WLDN,WLFC,WIBC,WIN,WINA,WTFC,WTFCW,WETF,GULF,CHXF,EMCB,DGRE,GLCB,DXJS,DGRW";
