...
int main(int argc, char* argv[]){
    yfinance::init();
    std::string layout = "name,currency,close,open,last trade price,ask,bid,year target price,average volume,volume,%change,dividend,%dividend,revenue,market cap,book";
